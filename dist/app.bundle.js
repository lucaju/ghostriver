...
const showPost = async ({id, slug}) => {
	...
	//fly to local
	_geodata__WEBPACK_IMPORTED_MODULE_2__["default"].setCurrentNodeAppearence(postData);
...
const drawPoints =  ({data, transitionTime = 5000, delayTime = 1000}) => {
	...
	nodesPoint = svg.selectAll('.circle')
		...
		.on('click', function (d) {
			...
			currentSelected = d;
			resetNodesState(d);
			Object(d3_dist_d3_min__WEBPACK_IMPORTED_MODULE_0__["select"])(this).transition()
...
const setCurrentNodeAppearence = node => {
