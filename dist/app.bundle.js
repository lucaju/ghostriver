...
const showPage = async ({id, slug}) => {
	...
	_contentHTML__WEBPACK_IMPORTED_MODULE_3__["default"].updatePage(activePanel, pageData);
...
const showPanel = ({activePanel = 'left-panel', direction = 'none', delay = 0}) => {
	...
	if (activePanel === 'full-panel') {
		Object(d3_dist_d3_min__WEBPACK_IMPORTED_MODULE_0__["select"])('#full-panel')
			.style('opacity', 0)
...
const updatePage = (activePanel, {title, content}) => {
	//dom manipulation
	const panel = Object(d3_dist_d3_min__WEBPACK_IMPORTED_MODULE_0__["select"])(`#${activePanel}`);
